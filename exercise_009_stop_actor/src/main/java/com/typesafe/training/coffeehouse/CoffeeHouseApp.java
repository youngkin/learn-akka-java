...
public class CoffeeHouseApp implements Terminal{
    ...
    private final Integer caffeineLimit =
            ConfigFactory.load().getInt("coffee-house.caffeine-limit");
    ...
    public CoffeeHouseApp(final ActorSystem system){
        ...
        coffeeHouse = createCoffeeHouse(caffeineLimit);
    }
    ...
    protected ActorRef createCoffeeHouse(Integer caffeineLimit){
